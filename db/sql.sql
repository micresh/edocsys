...
contracts.date_cash_income,
contracts.date_planed_reatt_1,
(IF(ISNULL(contracts.date_real_reatt_1), contracts.date_planed_reatt_1 - CURDATE(), 0)) as days_to_deadline_reatt_1,
contracts.date_real_reatt_1,
contracts.date_planed_reatt_2,
(IF(ISNULL(contracts.date_real_reatt_2), contracts.date_planed_reatt_2 - CURDATE(), 0)) as days_to_deadline_reatt_2,
contracts.date_real_reatt_2,
contracts.date_planed_resert,
(IF(ISNULL(contracts.date_real_resert), contracts.date_planed_resert - CURDATE(), 0)) as days_to_deadline_resert,
contracts.date_real_resert,
products.id AS pkproducts_id,
products.name AS products_name,
agents.id AS pkagents_id,
