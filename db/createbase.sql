...
ENGINE = InnoDB;
CREATE  TABLE IF NOT EXISTS `issl1`.`Experts` (
...
ENGINE = InnoDB;
CREATE  TABLE IF NOT EXISTS `issl1`.`Products` (
...
ENGINE = InnoDB;
CREATE  TABLE IF NOT EXISTS `issl1`.`ProdGost` (
  `id` INT NOT NULL ,
  `idProducts` INT NULL ,
  ...
  CONSTRAINT `fk_ProdGost_1`
    ...
    REFERENCES `issl1`.`Products` (`idProducts` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
CREATE  TABLE IF NOT EXISTS `issl1`.`Contracts` (
  ...
  CONSTRAINT `fk_Contracts_1`
    ...
    REFERENCES `issl1`.`Agents` (`idAgents` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Contracts_2`
    FOREIGN KEY (`expert_id` )
    REFERENCES `issl1`.`Experts` (`idExperts` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Contracts_3`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
CREATE  TABLE IF NOT EXISTS `issl1`.`Exec_contracts` (
  ...
  CONSTRAINT `fk_Exec_contracts_1`
    ...
    REFERENCES `issl1`.`Contracts` (`idContract` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
CREATE  TABLE IF NOT EXISTS `issl1`.`users` (
  `login` VARCHAR(50) NULL ,
  `password` VARCHAR(50) NULL ,
  `type` INT NULL ,
  `log_database` VARCHAR(50) NULL )
ENGINE = InnoDB;
CREATE  TABLE IF NOT EXISTS `issl1`.`log_journal` (
